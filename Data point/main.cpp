...
//function named make that creates and returns a unique_ptr to a vector of shared_ptrs to Test objects. 
std::unique_ptr<std::vector<std::shared_ptr<Test>>> make()
{
...
/*a function named fill that expects a vector of shared pointers to Test objects and a int
   representing the number of Test objects to create dynamically and add to the vector.*/
void fill(std::vector<std::shared_ptr<Test>> &vec, int num)
{
    int temp{};
...
/*a function named display that expects a vector of shared_ptrs to Test object and displays the
   data in each Test object*/
void display(const std::vector<std::shared_ptr<Test>>&vec)
{
    std::cout << "Disiplaying vector data" << std::endl;
    std::cout << "==============================" << std::endl;
